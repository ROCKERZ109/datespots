                ...
                if (!snapshot.empty) {
                    ...
                    const related = relatedSnapshot.docs
                        .map((d) => ({
                            id: d.id,
                            ...d.data(),
                            publishedAt: d.data().publishedAt?.toDate?.() || new Date(d.data().publishedAt),
                        } as BlogPost))
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-rose-50 via-fuchsia-50/50 to-violet-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Post not found</h1>
                    <p className="text-gray-400 mb-6">This article doesn't exist or has been removed.</p>
                    <Link href="/blog">
                        <span className="text-rose-500 font-semibold hover:underline cursor-pointer">← Back to Blog</span>
                    </Link>
                </div>
            </div>
        );
            ...
            <div className="min-h-screen bg-gradient-to-br from-rose-50 via-fuchsia-50/50 to-violet-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 relative">
              ...
              mb-16"
                    ...
                    {relatedPosts.length > 0 && (
                        <div className="mb-16">
                            <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200 mb-6">More like this</h3>
                                    ...
                                    <Link key={related.id} href={`/blog/${related.slug}`}>
                                        ...
                                        >
                                            ...
                                            <div className="p-4">
                                                ...
                                                <p className="text-[11px] text-gray-400 mt-1.5">{related.readTime} min read</p>
                                            </div>
                                        </motion.div>
                                    </Link>
                                ))}
